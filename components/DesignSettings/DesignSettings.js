...
import { ReactionColorPicker } from '../ColorPicker/ReactionColorPicker';
...
export const DesignSettings = ({ setShowSettings, project, saveChanges, setDisable }) => {
    ...
    return (
        <View style={styles.sectionContainer}>
            ...
            <View style={{ paddingTop: 5 }}>
                <ReactionTextInput label={"Design Name"} placeholder={"Survey Name"} value={name} onChange={setName}></ReactionTextInput>
                <ReactionTextInput label={"Description"} placeholder={"Description"} value={description} onChange={setDescription}></ReactionTextInput>
                <ReactionColorPicker></ReactionColorPicker>
