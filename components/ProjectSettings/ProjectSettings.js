    ...
    return (
        <View style={styles.sectionContainer}>
            ...
            <ScrollView style={{paddingTop: 5}}>
                ...
                <ReactionSelectInput isMultiple chosenList={selectedAudiences} chooseList={audiences} label={"Audiences"} placeholder={"No Audiences Chosen"} value={project?.description} setChosen={onSelectedAudienceChange} setChooseList={setAudiences}></ReactionSelectInput>
